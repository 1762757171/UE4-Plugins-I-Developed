...
class FRoomRelationshipGraphConnectionDrawingPolicy : public FConnectionDrawingPolicy
{
public:
    FRoomRelationshipGraphConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect, FSlateWindowElementList& InDrawElements, UEdGraph* InGraphObj);
